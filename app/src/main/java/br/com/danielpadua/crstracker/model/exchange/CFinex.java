...
import static br.com.danielpadua.crstracker.util.CRSUtil.GLOBAL_CFINEX_API_CALL_TIMER;

/**
 * Created by danielpadua on 29/03/2018.
 */

public class CFinex extends Exchange {
    ...
    public Pair getBitcoinPair() {
        if (this.bitcoinPair == null) {
            this.bitcoinPair = new RealPair(0, "BTC", new ArrayList<TickerPrice>(), "https://cfinex.com/#CRS-BTC", "https://cfinex.com/api/data?Pair=CRS_BTC", false, GLOBAL_CFINEX_API_CALL_TIMER, null);
        }
    ...
    public int getRefreshCooldownSeconds() {
        return GLOBAL_CFINEX_API_CALL_TIMER;
    }
}
