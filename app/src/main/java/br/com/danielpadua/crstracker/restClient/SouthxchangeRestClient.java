...
public class SouthxchangeRestClient extends RestClient<Southxchange> {
    ...
    protected Exchange doInBackground(WidgetTracker... widgetTrackers) {
        ...
        //} else {
        //  Pair pair = exchange.getPairById(super.widgetTracker.getChosenPairId());
        //  updatePair(pair);
        //}
...
//    @Override
//    protected Pair updatePair(Pair pair) {
//        List<Pair> pairs = new ArrayList<>();
//        pairs.add(pair);
//        return updateAllPairs(pairs).get(0);
//    }
